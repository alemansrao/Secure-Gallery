  ...
  <header class="header-bar d-flex d-lg-block align-items-center" data-aos="fade-left">
    ...
    <div class="main-menu">
      <ul class="js-clone-nav">
        ...
        <li><a href="photos.php"hotos</a></li>
        <li class="active"><a href="bio.php"io</a></li>
        <li><a href="blog.php"log</a></li>
        <li><a href="contact.php"ontact</a></li>
      </ul>
